...
DELETE FROM `back_acl_menu`;
INSERT INTO `back_acl_menu` (`id`, `pid`, `type`, `name`, `link`, `status`, `display`, `order`) VALUES
	(1, 0, 1, '权限', 'acl', 1, 1, 90),
...
DELETE FROM `back_acl_role`;
INSERT INTO `back_acl_role` (`id`, `name`, `behavior`) VALUES
...
DELETE FROM `back_admin`;
INSERT INTO `back_admin` (`id`, `name`, `password`, `t`, `rid`) VALUES
	(1, 'admin', '1f604490cbdd4ec35cfa681bcf3df8fac26e0cb5', 1, 0);

CREATE TABLE IF NOT EXISTS `back_security_card` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DELETE FROM `back_security_card`;
